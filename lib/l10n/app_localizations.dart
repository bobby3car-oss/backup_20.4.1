...
abstract class AppLocalizations {
  ...
  ///
  /// In de, this message translates to:
  /// **'Nie wieder unsicher vor der OP'**
  String get onboardingSlide1Title;

  /// No description provided for @onboardingSlide1Subtitle.
  ///
  /// In de, this message translates to:
  /// **'Dein persönlicher Begleiter führt dich sicher durch jede Phase — von der Vorbereitung bis zur vollständigen Genesung.'**
  String get onboardingSlide1Subtitle;

  /// No description provided for @onboardingSlide1Feature1.
  ///
  /// In de, this message translates to:
  /// **'Persönlicher Zeitstrahl für deine OP'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Kein Termin, kein Detail vergessen'**
  String get onboardingSlide2Title;

  /// No description provided for @onboardingSlide2Subtitle.
  ///
  /// In de, this message translates to:
  /// **'Automatische Erinnerungen und Packlisten — damit du dich auf das Wesentliche konzentrieren kannst.'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Veränderungen erkennen, bevor es kritisch wird'**
  String get onboardingSlide4Title;

  /// No description provided for @onboardingSlide4Subtitle.
  ///
  /// In de, this message translates to:
  /// **'Dokumentiere deine Wundheilung mit Fotos und lass dich bei Warnsignalen rechtzeitig benachrichtigen.'**
  String get onboardingSlide4Subtitle;

  /// No description provided for @onboardingSlide4Feature1.
  ///
  /// In de, this message translates to:
  /// **'Foto-Dokumentation der Wundheilung'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Tausende Patienten vertrauen bereits auf den Operationsbegleiter.'**
  ...
  /// No description provided for @parentalConsentAge.
  ///
  /// In de, this message translates to:
  /// **'Du bist unter 16 Jahre alt.'**
  String get parentalConsentAge;

  /// No description provided for @parentalConsentText.
  ///
  /// In de, this message translates to:
  /// **'Ich bestätige, dass meine Eltern oder Erziehungsberechtigten der Nutzung dieser App und der Verarbeitung meiner Daten ausdrücklich zugestimmt haben (DSGVO Art. 8).'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Wichtiger Hinweis: Diese App ersetzt keine ärztliche Beratung, Diagnose oder Behandlung. Alle Inhalte dienen ausschließlich der allgemeinen Information. Wende dich bei gesundheitlichen Beschwerden immer an deinen Arzt oder dein medizinisches Team.'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Der KI-Assistent (Bella AI) nutzt externe Dienste, um deine Fragen zu beantworten:\n\n• Deine Chat-Nachrichten werden an OpenAI (USA) übermittelt.\n• Für Pro-Nutzer: Lokale Gesundheitsdaten (Schmerztagebuch, Vitalwerte, Medikamente, Ernährung, Warnungen, OP-Phase) werden als Kontext an den Dienst übertragen, um bessere Antworten zu liefern.\n• Wundfoto-Analysen werden über OpenAI (USA) verarbeitet und nach der Analyse gelöscht.\n\nKeine Daten werden dauerhaft bei den externen Diensten gespeichert. Du kannst deine Zustimmung jederzeit in den Einstellungen widerrufen.\n\nRechtsgrundlage: Art. 6(1)(a) und Art. 9(2)(a) DSGVO.'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Bella ist kein Ersatz für ärztlichen Rat. Bei Beschwerden wende dich bitte an deinen Arzt.'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Absturzberichte senden, um Fehler zu beheben'**
  ...
  /// No description provided for @datenExportErfolgreich.
  ///
  /// In de, this message translates to:
  /// **'Daten erfolgreich exportiert'**
  String get datenExportErfolgreich;

  /// No description provided for @datenExportFehler.
  ///
  /// In de, this message translates to:
  /// **'Export fehlgeschlagen'**
  String get datenExportFehler;

  /// No description provided for @datenExportieren.
  ///
  /// In de, this message translates to:
  /// **'Daten exportieren'**
  String get datenExportieren;

  /// No description provided for @datenExportierenDsgvo.
  ///
  /// In de, this message translates to:
  ...
  ///
  /// In de, this message translates to:
  /// **'Schreibe uns eine E-Mail – wir helfen gerne'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Wie verbinde ich mich mit meinem Arzt?'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Wie funktioniert Bella, die KI-Assistentin?'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Teile diesen Code mit deinen Patienten'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Keine archivierten Operationen'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Erinnerungen für Genesungsaufgaben'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Schalte alle Pro-Funktionen frei'**
  ...
  /// No description provided for @staffSectionTitle.
  ///
  /// In de, this message translates to:
  /// **'Mitarbeiter'**
  String get staffSectionTitle;
  ...
  ///
  /// In de, this message translates to:
  /// **'Noch keine Nahrungsergänzungsmittel'**
  ...
  ///
  /// In de, this message translates to:
  /// **'{readCount} Lese-, {writeCount} Schreibrechte'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Verbindung zu {name} wirklich trennen?'**
