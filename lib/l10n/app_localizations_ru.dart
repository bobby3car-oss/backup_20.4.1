...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get parentalConsentText =>
      'Я подтверждаю, что мои родители или законные представители дали явное согласие на использование мной этого приложения и обработку моих данных (GDPR ст. 8).';
  ...
  String get bellaConsentBody =>
      'ИИ-ассистент (Bella AI) использует внешние сервисы для ответов на ваши вопросы:\n\n• Ваши сообщения чата передаются в OpenAI (США).\n• Для пользователей Pro: локальные данные о здоровье (дневник боли, показатели, лекарства, питание, предупреждения, фаза операции) передаются как контекст для более точных ответов.\n• Анализ фотографий ран обрабатывается через OpenAI (США) и удаляется после анализа.\n\nНикакие данные не хранятся постоянно у внешних сервисов. Вы можете отозвать согласие в любое время в Настройках.\n\nПравовое основание: ст. 6(1)(а) и ст. 9(2)(а) GDPR.';
