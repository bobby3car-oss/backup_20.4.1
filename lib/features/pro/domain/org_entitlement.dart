...
/// Represents the Pro entitlement state for an organisation (Org/Arzt account).
///
/// Reads flat fields from `organisations/{orgUid}`:
...
class OrgEntitlement {
  ...
  /// Whether the Org Pro entitlement is currently active (not expired).
  bool get isActive {
  ...
  factory OrgEntitlement.free() => const OrgEntitlement(isPro: false);

  factory OrgEntitlement.fromFirestore(Map<String, dynamic> data) {
  ...
  factory OrgEntitlement.fromJson(Map<String, dynamic> json) {
    return OrgEntitlement(
