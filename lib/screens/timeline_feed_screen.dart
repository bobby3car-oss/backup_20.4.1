...
class _TimelineFeedScreenState extends State<TimelineFeedScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AppBackground(
        child: StreamBuilder<List<TimelineItem>>(
      ...
      builder: (context, snapshot) {
        ...
        return Stack(
          ...
          slivers: [
            ...
            // ── Back button (when pushed as standalone route) ──
            if (canPop)
              Positioned(
                top: topPadding + AppSpacing.sm,
                left: AppSpacing.sm,
    ...
    Widget content = Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            children: [
              _OffsetBadge(label: section.offsetLabel),
              const Spacer(),
              Text(
                section.dateLabel,
                style: tt.labelMedium?.copyWith(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: isToday ? null : AppColors.grey200,
        borderRadius: AppRadius.borderRadiusPill,
        border: isToday
            ? null
