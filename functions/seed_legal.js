...
const privacy = {
  sections: [
    ...
    },
    {
      ...
      body:
        "Im Rahmen der Nutzung der App „Operationsbegleiter" " +
    ...
    },
    {
      ...
      body:
        "Zur Erbringung der App-Funktionen werden Dienste von " +
    ...
    },
    {
      ...
      body:
        "Diese Datenschutzerklärung kann angepasst werden, um " +
...
const terms = {
  sections: [
    ...
    },
    {
      ...
      body:
        "a) Die App wird \"wie besehen\" (as is) bereitgestellt. " +
    ...
    },
    {
      ...
      body:
        "Es wird eine möglichst hohe Verfügbarkeit der App " +
    ...
    },
    {
      ...
      body:
        "Es wird keine Garantie oder Zusicherung dafür " +
    ...
    },
    {
      ...
      body:
        "Diese Nutzungsbedingungen können mit Wirkung für " +
